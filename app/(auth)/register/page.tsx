  ...
  return (
    <section className="flex items-center justify-center min-h-screen bg-lavender-100 px-4">
      <div className="w-full max-w-md p-6 bg-white rounded-lg shadow-md">
        <h1 className="text-2xl font-semibold text-center text-purple-700">Sign up to CBS</h1>
        <p className="text-sm text-center text-gray-500 mb-6">We just need a few details to get you started.</p>
